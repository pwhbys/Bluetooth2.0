 ...
 */
public class WMFloatLayout extends ViewGroup {
    ...
    public WMFloatLayout(Context context) {
        this(context, null);
    }

    public WMFloatLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WMFloatLayout(Context context, AttributeSet attrs, int defStyleAttr) {
