...
public class WMNavigationBar extends LinearLayout {

    private static final String TAG = "WMNavigationBar";

    public static final String ACTION_INPUT = "com.widemouth.bluetooth20.action.INPUT";
    ...
    private WMViewPager mViewPager;
    ...
    private WMNavigationBar.OnTabClickListener onTabClickListener;
    ...
    //Add
    private WMNavigationBar.OnAddClickListener onAddClickListener;
    ...
    public WMNavigationBar(Context context) {
        super(context);

        initViews(context, null);
    }

    public WMNavigationBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initViews(Context context, AttributeSet attrs) {
        ...
        contentView = (RelativeLayout) View.inflate(context, R.layout.layout_navigation_container, null);
        ...
        navigationView = contentView.findViewById(R.id.navigationView);
        inputView = contentView.findViewById(R.id.inputView);
        initInputView();
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.WMNavigationBar);
    ...
    private void initInputView() {
        ...
        final EditText editText = inputView.findViewById(R.id.inputEditText);
        final Button sendButton = inputView.findViewById(R.id.sendButton);
        ...
        //设置圆角角度
        int radius = WMUtil.dip2px(getContext(), 18);
        ...
        sendButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (editText.getText().toString().length() > 0) {
                    ...
                    intent.putExtra(ACTION_INPUT, editText.getText().toString());
                    editText.setText("");
        ...
        editText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (s.length() > 0) {
                    drawable.setColor(0xDDEE7C3D);
                    sendButton.setBackground(drawable);
                } else {
                    drawable.setColor(0x50EE7C3D);
                    sendButton.setBackground(drawable);
                }
            }
        });
    ...
    public void showInputView() {
        if (inputView.getVisibility() != VISIBLE) {
            inputView.setVisibility(VISIBLE);
        }
    }

    public void hideInputView() {
        if (inputView.getVisibility() != GONE) {
            inputView.setVisibility(GONE);
        }
    }
    ...
    private void parseStyle(TypedArray attributes) {
        if (attributes != null) {
            navigationHeight = attributes.getDimension(R.styleable.WMNavigationBar_Easy_navigationHeight, navigationHeight);
            navigationBackground = attributes.getColor(R.styleable.WMNavigationBar_Easy_navigationBackground, navigationBackground);


            tabTextSize = attributes.getDimension(R.styleable.WMNavigationBar_Easy_tabTextSize, tabTextSize);
            tabTextTop = attributes.getDimension(R.styleable.WMNavigationBar_Easy_tabTextTop, tabTextTop);
            iconSize = (int) attributes.getDimension(R.styleable.WMNavigationBar_Easy_tabIconSize, iconSize);
            hintPointSize = attributes.getDimension(R.styleable.WMNavigationBar_Easy_hintPointSize, hintPointSize);
            msgPointSize = attributes.getDimension(R.styleable.WMNavigationBar_Easy_msgPointSize, msgPointSize);
            hintPointLeft = attributes.getDimension(R.styleable.WMNavigationBar_Easy_hintPointLeft, hintPointLeft);
            msgPointTop = attributes.getDimension(R.styleable.WMNavigationBar_Easy_msgPointTop, -iconSize / 2);
            hintPointTop = attributes.getDimension(R.styleable.WMNavigationBar_Easy_hintPointTop, hintPointTop);

            msgPointLeft = attributes.getDimension(R.styleable.WMNavigationBar_Easy_msgPointLeft, -iconSize / 2);
            msgPointTextSize = attributes.getDimension(R.styleable.WMNavigationBar_Easy_msgPointTextSize, msgPointTextSize);
            addIconSize = attributes.getDimension(R.styleable.WMNavigationBar_Easy_addIconSize, addIconSize);
            addLayoutBottom = attributes.getDimension(R.styleable.WMNavigationBar_Easy_addLayoutBottom, addLayoutBottom);

            //加号属性
            addSelectTextColor = attributes.getColor(R.styleable.WMNavigationBar_Easy_addSelectTextColor, addSelectTextColor);
            addNormalTextColor = attributes.getColor(R.styleable.WMNavigationBar_Easy_addNormalTextColor, addNormalTextColor);
            addTextSize = attributes.getDimension(R.styleable.WMNavigationBar_Easy_addTextSize, addTextSize);
            addTextTopMargin = attributes.getDimension(R.styleable.WMNavigationBar_Easy_addTextTopMargin, addTextTopMargin);
            addAlignBottom = attributes.getBoolean(R.styleable.WMNavigationBar_Easy_addAlignBottom, addAlignBottom);


            lineHeight = attributes.getDimension(R.styleable.WMNavigationBar_Easy_lineHeight, lineHeight);
            lineColor = attributes.getColor(R.styleable.WMNavigationBar_Easy_lineColor, lineColor);


            addLayoutHeight = attributes.getDimension(R.styleable.WMNavigationBar_Easy_addLayoutHeight, navigationHeight + lineHeight);

            normalTextColor = attributes.getColor(R.styleable.WMNavigationBar_Easy_tabNormalColor, normalTextColor);
            selectTextColor = attributes.getColor(R.styleable.WMNavigationBar_Easy_tabSelectColor, selectTextColor);

            int type = attributes.getInt(R.styleable.WMNavigationBar_Easy_scaleType, 0);
            if (type == 0) {
            ...
            addLayoutRule = attributes.getInt(R.styleable.WMNavigationBar_Easy_addLayoutRule, addLayoutRule);
            hasPadding = attributes.getBoolean(R.styleable.WMNavigationBar_Easy_hasPadding, hasPadding);

            addAsFragment = attributes.getBoolean(R.styleable.WMNavigationBar_Easy_addAsFragment, addAsFragment);
...
//若没有设置中间添加的文字字体大小、颜色、则同其他Tab一样
    ...
    public void buildNavigation() {
        ...
        for (int i = 0; i < tabCount; i++) {
            View itemView = View.inflate(getContext(), R.layout.layout_navigation_tab, null);
            ...
            navigationView.addView(itemView);
        }
        select(0, false);
    }
    ...
    private void setViewPagerAdapter() {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                WMNavigationBar.this.position = position;
            }
    ...
    public void buildAddNavigation() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (i == tabCount / 2) {
                ...
                navigationView.addView(addItemView);
    ...
    public void buildAddViewNavigation() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (i == tabCount / 2) {
                ...
                final RelativeLayout.LayoutParams linearParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                //linearParams.width = com.widemouth.board.wmView.wmNavigationBar.NavigationUtil.getScreenWidth(getContext()) / tabCount;
    ...
    public WMViewPager getViewPager() {
        return mViewPager;
    }
    ...
    public WMNavigationBar addOnPageChangeListener(ViewPager.OnPageChangeListener onPageChangeListener) {
    ...
    public WMNavigationBar addLayoutHeight(int addLayoutHeight) {
        this.addLayoutHeight = NavigationUtil.dip2px(getContext(), addLayoutHeight);
        return this;
    }

    public WMNavigationBar scaleType(ImageView.ScaleType scaleType) {
        this.scaleType = scaleType;
        return this;
    }


    public WMNavigationBar mode(int mode) {
        this.mode = mode;
        return this;
    }

    public WMNavigationBar hasPadding(boolean hasPadding) {
        this.hasPadding = hasPadding;
        return this;
    }

    public WMNavigationBar addIconSize(int addIconSize) {
        this.addIconSize = NavigationUtil.dip2px(getContext(), addIconSize);
        return this;
    }

 /*   public com.widemouth.board.wmView.EasyNavigationBar onAddClickListener(com.widemouth.board.wmView.EasyNavigationBar.OnAddClickListener onAddClickListener) {
        this.onAddClickListener = onAddClickListener;
        return this;
    }*/


    public WMNavigationBar navigationBackground(int navigationBackground) {
        this.navigationBackground = navigationBackground;
        return this;
    }

    public WMNavigationBar navigationHeight(int navigationHeight) {
        this.navigationHeight = NavigationUtil.dip2px(getContext(), navigationHeight);
        return this;
    }

    public WMNavigationBar normalTextColor(int normalTextColor) {
        this.normalTextColor = normalTextColor;
        return this;
    }

    public WMNavigationBar selectTextColor(int selectTextColor) {
        this.selectTextColor = selectTextColor;
        return this;
    }

    public WMNavigationBar lineHeight(int lineHeight) {
        this.lineHeight = lineHeight;
        return this;
    }

    public WMNavigationBar lineColor(int lineColor) {
        this.lineColor = lineColor;
        return this;
    }

    public WMNavigationBar tabTextSize(int tabTextSize) {
        this.tabTextSize = NavigationUtil.sp2px(getContext(), tabTextSize);
        return this;
    }

    public WMNavigationBar tabTextTop(int tabTextTop) {
        this.tabTextTop = NavigationUtil.dip2px(getContext(), tabTextTop);
        return this;
    }

    public WMNavigationBar msgPointTextSize(int msgPointTextSize) {
        this.msgPointTextSize = NavigationUtil.sp2px(getContext(), msgPointTextSize);
        return this;
    }

    public WMNavigationBar msgPointSize(int msgPointSize) {
        this.msgPointSize = NavigationUtil.dip2px(getContext(), msgPointSize);
        return this;
    }

    public WMNavigationBar msgPointLeft(int msgPointLeft) {
        this.msgPointLeft = NavigationUtil.dip2px(getContext(), msgPointLeft);
        return this;
    }

    public WMNavigationBar msgPointTop(int msgPointTop) {
        this.msgPointTop = NavigationUtil.dip2px(getContext(), msgPointTop);
        return this;
    }


    public WMNavigationBar hintPointSize(int hintPointSize) {
        this.hintPointSize = NavigationUtil.dip2px(getContext(), hintPointSize);
        return this;
    }

    public WMNavigationBar hintPointLeft(int hintPointLeft) {
        this.hintPointLeft = NavigationUtil.dip2px(getContext(), hintPointLeft);
        return this;
    }

    public WMNavigationBar hintPointTop(int hintPointTop) {
        this.hintPointTop = NavigationUtil.dip2px(getContext(), hintPointTop);
        return this;
    }


    public WMNavigationBar titleItems(String[] titleItems) {
        this.titleItems = titleItems;
        return this;
    }

    public WMNavigationBar normalIconItems(int[] normalIconItems) {
        this.normalIconItems = normalIconItems;
        return this;
    }

    public WMNavigationBar selectIconItems(int[] selectIconItems) {
        this.selectIconItems = selectIconItems;
        return this;
    }

    public WMNavigationBar fragmentList(List<Fragment> fragmentList) {
        this.fragmentList = fragmentList;
        return this;
    }

    public WMNavigationBar fragmentManager(FragmentManager fragmentManager) {
        this.fragmentManager = fragmentManager;
        return this;
    }

    public WMNavigationBar anim(Anim anim) {
        if (anim != null) {
    ...
    public WMNavigationBar addLayoutRule(int addLayoutRule) {
        this.addLayoutRule = addLayoutRule;
        return this;
    }

    public WMNavigationBar canScroll(boolean canScroll) {
        this.canScroll = canScroll;
        return this;
    }

    public WMNavigationBar smoothScroll(boolean smoothScroll) {
        this.smoothScroll = smoothScroll;
        return this;
    }


    public WMNavigationBar onTabClickListener(WMNavigationBar.OnTabClickListener onTabClickListener) {
        this.onTabClickListener = onTabClickListener;
        return this;
    }


    public WMNavigationBar iconSize(int iconSize) {
        this.iconSize = NavigationUtil.dip2px(getContext(), iconSize);
        return this;
    }

    public WMNavigationBar addLayoutBottom(int addLayoutBottom) {
        this.addLayoutBottom = NavigationUtil.dip2px(getContext(), addLayoutBottom);
        return this;
    }

    public WMNavigationBar addAsFragment(boolean addAsFragment) {
        this.addAsFragment = addAsFragment;
        return this;
    }

    public WMNavigationBar addCustomView(View customAddView) {
        this.customAddView = customAddView;
        return this;
    }

    public WMNavigationBar addTextSize(int addTextSize) {
        this.addTextSize = NavigationUtil.sp2px(getContext(), addTextSize);
        return this;
    }

    public WMNavigationBar addNormalTextColor(int addNormalTextColor) {
        this.addNormalTextColor = addNormalTextColor;
        return this;
    }

    public WMNavigationBar addSelectTextColor(int addSelectTextColor) {
        this.addSelectTextColor = addSelectTextColor;
        return this;
    }

    public WMNavigationBar addTextTopMargin(int addTextTopMargin) {
        this.addTextTopMargin = NavigationUtil.dip2px(getContext(), addTextTopMargin);
        return this;
    }

    public WMNavigationBar addAlignBottom(boolean addAlignBottom) {
    ...
    public WMNavigationBar.OnTabClickListener getOnTabClickListener() {
    ...
    public WMNavigationBar.OnAddClickListener getOnAddClickListener() {
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            touchDownX = x;
            touchDownY = y;
            Log.d(TAG, "dispatchTouchEvent: " + dx + "  " + dy);
            if (Math.abs(dx) > Math.abs(dy * 1.1)) {
                return super.dispatchTouchEvent(event);
            }
            if (dy < 0) {// 上滑隐藏
                if (outAnimator == null) {
                    outAnimator = ObjectAnimator.ofFloat(AddContainerLayout, "translationY", 0, navigationView.getHeight());
                    outAnimator.setDuration(200);
                }
                if (!outAnimator.isRunning() && AddContainerLayout.getTranslationY() <= 0) {
                    outAnimator.start();
                }
            } else if (dy > 0) {// 下滑显示
                if (inAnimator == null) {
                    inAnimator = ObjectAnimator.ofFloat(AddContainerLayout, "translationY", navigationView.getHeight(), 0);
                    inAnimator.setDuration(200);
                }
                if (!inAnimator.isRunning() && AddContainerLayout.getTranslationY() >= navigationView.getHeight()) {
                    inAnimator.start();
                }
            }
        }
