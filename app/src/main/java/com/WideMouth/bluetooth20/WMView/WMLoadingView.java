 ...
 * @date 2016-09-21
 */
public class WMLoadingView extends AppCompatImageView implements IQMUISkinDefaultAttrProvider {
    ...
    public WMLoadingView(Context context) {
        this(context, null);
    }

    public WMLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.QMUILoadingStyle);
    }

    public WMLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public WMLoadingView(Context context, int size, int color) {
        super(context);
        mSize = size;
        mPaintColor = color;
        initPaint();
